    ...
    while (ros::ok())
    {
		...
		// -----------------------------------------------------------------------
			...
			if(M[240]>0){
				...
				* \arg  VÃ©rifie si le produit est fabriquer pour pouvoir lancer le prochain en initialisant le nouveau nombre de sÃ©quence
				* \arg \b Precondition: M[240]
				* \arg \b Postcondition: M[241]++;
				*/
				M[240]--;
			...
			if(M[207] && M[209] && M[3] && Prod_seqdeposte[index1_prod-1][index1_seq] == POSTE_3){
				/*!
				* \b T207_209_3_1:  Ajout d'un produit au poste 3 
			...
			if(M[207] && M[242] && M[3] && Prod_seqdeposte[index2_prod-1][index2_seq] == POSTE_3){
				/*!
				* \b T207_240_3_2:  Ajout d'un produit au poste 3 
				* \arg  VÃ©rifie si le poste de dÃ©part de la gamme d'un produit est le poste 3 et si le poste 3 est libre
			...
			if(M[212] && M[241]==0){
				/*!
				* \b T212_241barre:  Evacuation du produit au poste 3
				* \arg  fin de fabrication au poste 3 et Ã©vacuation
				* \arg \b Precondition: M[212] && M[241]==0
			...
			if(M[212] && M[241]>0 && M[252]){
				/*!
				* \b T212_241:  gamme non Ã©puisÃ©e
				* \arg  fin de tÃ¢che au poste 3 
			...
			if(M[220] && M[4] && M[251] && Prod_seqdeposte[index_prod_post3-1][index_seq_post3+1] == POSTE_4){
				/*!
				* \b T220bis_4_1:  Deplacement du produit du poste 3 vers le poste 4 
				* \arg  La sÃ©quence suivante du produit se fait au poste 4 donc on l'y deplace et poste 4 est libre
			...
			if(M[220] && M[4] && M[252] && Prod_seqdeposte[index_prod_post3-1][index_seq_post3+1] == POSTE_4){
				/*!
				* \b T220bis_4_2:  Deplacement du produit du poste 3 vers le poste 4 
				* \arg  La sÃ©quence suivante du produit se fait au poste 4 donc on l'y deplace et le poste 4 est libre
			...
			if(M[217] && M[241]==0){
				...
				* \arg   Le produit est fini et prÃªt Ã  Ãªtre Ã©vacuer
				* \arg \b Precondition:  M[217] && M[241]==0
				* \arg \b Postcondition: M[229]++;
				*/
				M[217]--;
				M[229]++;
			...
			if(M[229] && M[3] && M[214]){
				...
				* \arg \b Precondition:  M[229] && M[3] && M[214]
				* \arg \b Postcondition: M[218]++; M[4]++;
				*/
				M[229]--;
				M[214]--;
				M[3]--;
			...
			if(M[229] && M[3]==0){
				/*!
				* \b T229_214:  DÃ©placement du produit du poste 4 vers le poste 3
				* \arg   Le produit est fini et prÃªt Ã  Ãªtre Ã©vacuer et poste 3 n'est pas libre
				* \arg \b Precondition:  M[229] && M[3]==0
				* \arg \b Postcondition: M[230]++;
				*/
				M[229]--;
				M[230]++;
				display();
			...
			if(M[232] && capteur.get_PS(2)){
				...
				* \arg \b Precondition:  M[233] && M[214]
				* \arg \b Postcondition: M[234]++; 
				*/
				M[233]--;
			...
			if(M[236] && M[258] && robot.FinDeplacerPiece(ROBOT_2)){
				/*!
				* \b T236_258:  Deplacer le produit du poste 3 vers la navette
				* \arg  Deplacer le produit du poste 3 vers la navette
				* \arg \b Precondition:  M[236] && M[258] && robot.FinDeplacerPiece()
				* \arg \b Postcondition: ; M[237]++;  M[212]++;
				*/
				M[236]--;
				M[258]--;
				M[237]++;
