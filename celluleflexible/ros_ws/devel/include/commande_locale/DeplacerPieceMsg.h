...
bool operator==(const ::commande_locale::DeplacerPieceMsg_<ContainerAllocator1> & lhs, const ::commande_locale::DeplacerPieceMsg_<ContainerAllocator2> & rhs)
{
  return lhs.num_robot == rhs.num_robot &&
    lhs.positionA == rhs.positionA &&
    lhs.positionB == rhs.positionB;
}
